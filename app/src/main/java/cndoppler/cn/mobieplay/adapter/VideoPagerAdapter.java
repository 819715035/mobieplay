package cndoppler.cn.mobieplay.adapter;
...
public class VideoPagerAdapter extends BaseAdapter {
    ...
    private final ArrayList<VideoData> mediaItems;
    private Utils utils;

    public VideoPagerAdapter(Context context,ArrayList<VideoData> mediaItems,boolean isVideo){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        VideoData mediaItem = mediaItems.get(position);
        viewHoder.tv_name.setText(mediaItem.getName());
        viewHoder.tv_size.setText(Formatter.formatFileSize(context, mediaItem.getSize()));
        viewHoder.tv_time.setText(utils.stringForTime((int) mediaItem.getTime()));
